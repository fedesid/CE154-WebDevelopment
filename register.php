		...
		<div class="addgame_container" style="margin-top: 3%">			
			<div class="managegame" style="width: 15%">
				...
				<form action="" method="post">
					...
					<input type="password" id="password" name="password_1" placeholder="Password"><br><br>

                    <input type="password" id="password" name="password_2" placeholder="Confirm Password"><br><br>
